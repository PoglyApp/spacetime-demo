...
export class ClearAllTasksReducer extends Reducer
{
	public static reducerName: string = "ClearAllTasks";
	public static call() {
	...
	public call() {
		...
		this.client.call("ClearAllTasks", serializer);
	}
	...
	{
		this.client.on("reducer:ClearAllTasks", callback);
	}
}


export default ClearAllTasksReducer
